...
* [jamchamb's blog](https://jamchamb.net/){:target="_blank"}
...
* [PS2Wide](https://web.archive.org/web/20250516062842/http://ps2wide.net/pc.html){:target="_blank"} *(archived)* -- widescreen patches for PC and console games from nemesis2000.
* [Rings of Saturn](https://32bits.substack.com/){:target="_blank"} -- a retro games reverse engineering newsletter from Bo Bayles.
...
* [Widescreen Fixes Pack](https://fusionfix.io/wfp){:target="_blank"} -- plugins to make or improve widescreen resolutions support in PC games from ThirteenAG.
