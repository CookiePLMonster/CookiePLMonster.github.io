...
{% include figures/image.html link="/assets/img/posts/godfather/image3.png" caption="Yes, this is a virtual machine. You get the point, though." %}

...while on Windows Vista or **any** newer system (including Windows 10, of course) movies look more like this:
{% include figures/image.html thumbnail="/assets/img/posts/godfather/image6.png" style="natural"
                           caption="This is Windows 10, but I assure it’s just the same on Vista, 7, 8 and 8.1." %}
...
{% include figures/image.html link="/assets/img/posts/godfather/image19.png" %}
...
{% include figures/image.html link="/assets/img/posts/godfather/image14.png" style="natural" %}
...
{% include figures/image.html link="/assets/img/posts/godfather/image17.png"
               caption="`REAL_abortmessage` triggers a breakpoint internally, which means the \"crash\" we have been encountering is a controlled \"something is wrong, you need to investigate ASAP\" debug measure which somehow found its way into the shipping build." %}
...
{% include figures/image.html link="/assets/img/posts/godfather/image2.png" caption="This is almost like yin and yang -- except here one of them is correct and the other is not." %}
...
{% include figures/image.html link="/assets/img/posts/godfather/image10.png" style="natural" %}
...
{% include figures/image.html link="/assets/img/posts/godfather/image9.png" style="natural" %}
...
{% include figures/image.html link="/assets/img/posts/godfather/image15.png" caption="\"Caps\" means \"capabilities\", not \"headwear\"." %}
...
{% include figures/image.html link="/assets/img/posts/godfather/image20.png" style="natural" caption="We hit this code path, which means a flag check has failed." %}

To verify, let’s consult one of the tools from DirectX SDK - DirectX Caps Viewer:
{% include figures/image.html link="/assets/img/posts/godfather/image21.png" style="natural" %}
